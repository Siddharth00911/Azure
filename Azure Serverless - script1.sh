...
location="eastus"
resourceGroup="Siddharth-azure-functions-rg-$randomIdentifier"
tag="create-function-app-consumption-python"
storage="Siddharth$randomIdentifier"
functionApp="Siddharth-serverless-python-function-$randomIdentifier"
